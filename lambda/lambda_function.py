...
table = dynamodb.Table('nautilus-S3CopyLogs')  # Replace with your DynamoDB table name
...
def lambda_handler(event, context):
    try:
        ...
        destination_bucket = "nautilus-private-11517 "  # Replace with your destination bucket name
